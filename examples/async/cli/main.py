...
def parse_args():
    ...
    parser.add_argument(
        "--timeout", "-t", type=float, default=2.5, help="(optional) operation timeout (in seconds). Defaults to 2.5."
    )
    ...
    set_antipassback.add_argument(
        "--antipassback", type=str, help="disabled, (1:2);(3:4), (1,3):(2,4), 1:(2,3) or 1:(2,3,4)"
    )
