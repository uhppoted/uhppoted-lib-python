...
GetControllersResponse = [
    structs.GetControllerResponse(controller=201020304,
    ...
    structs.GetControllerResponse(controller=303986753,
    ...
    structs.GetControllerResponse(controller=405419896,
                                  ip_address=IPv4Address('192.168.1.100'),
                                  subnet_mask=IPv4Address('255.255.255.0'),
                                  gateway=IPv4Address('192.168.1.1'),
...
GetControllerResponse = structs.GetControllerResponse(controller=405419896,
                                                      ip_address=IPv4Address('192.168.1.100'),
                                                      subnet_mask=IPv4Address('255.255.255.0'),
                                                      gateway=IPv4Address('192.168.1.1'),
                                                      mac_address='00:12:23:34:45:56',
...
GetStatusResponse = structs.GetStatusResponse(controller=405419896,
...
GetListenerResponse = structs.GetListenerResponse(controller=405419896,
...
GetCardResponse = structs.GetCardResponse(controller=405419896,
                                          card_number=8165538,
...
GetCardByIndexResponse = structs.GetCardByIndexResponse(controller=405419896,
                                                        card_number=8165539,
                                                        start_date=datetime.date(2023, 1, 1),
                                                        end_date=datetime.date(2023, 12, 31),
                                                        door_1=1,
...
GetEventResponse = structs.GetEventResponse(controller=405419896,
                                            index=29,
                                            event_type=2,
                                            access_granted=True,
                                            door=1,
...
GetTimeProfileResponse = structs.GetTimeProfileResponse(controller=405419896,
                                                        profile_id=29,
